...
pub mod android {
    ...
    #[no_mangle]
    pub unsafe extern "C" fn Java_com_krupitskas_pong_RustBindings_greeting(
        mut env: JNIEnv,
        _: JClass,
    ...
    #[no_mangle]
    pub unsafe extern "C" fn Java_com_krupitskas_pong_RustBindings_renderFractal(
        env: JNIEnv,
        _: JClass,
        bmp: JObject,
    ) {
